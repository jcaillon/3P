    ...
    internal class ProExecution {
        ...
        public bool Do(ExecutionType executionType) {
            ...
            foreach (var fileToCompile in ListToCompile) {
                ...
                var lastDeployment = ProEnv.GetTransfersNeeded(fileToCompile.InputPath).Last();
                ...
                if (lastDeployment.Value != DeployType.Move ||
                    ...
                    fileToCompile.CompOutputDir = lastDeployment.Key;
