...
namespace _3PA.MainFeatures.Pro.Deploy
{
    ...
    internal class DeploymentHandler
    {
        ...
        /// <summary>
        /// Get the deployment report body
        /// </summary>
        /// <returns></returns>
        public string FormatDeploymentReport()
        {
            ...
            html.AppendLine(@"
                <table class='ToolTipName' style='margin-bottom: 0px; width: 100%'>
                    <tr>
                        ...
                        <td class='Title'>Deployment report</td>
                    </tr>
                    <tr>");
            ...
            */
            ...
            try {
                html.AppendLine(FormatDeploymentParameters());
            } catch (Exception e) {
                ErrorHandler.ShowErrors(e, "Error when generating the deployment parameters report");
            }

            try {
                html.AppendLine(FormatDeploymentResults());
            } catch (Exception e) {
                ErrorHandler.ShowErrors(e, "Error when generating the deployment report");
            }
