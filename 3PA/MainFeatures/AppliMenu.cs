    ...
    internal class AppliMenu {
        ...
        private AppliMenu() {
            ...
            MainMenuList = new List<MenuItem> {
                ...
                new MenuItem(this, "Toggle current file as progress", ImageResources.Progress, item => ProMisc.ReadCurrentFileAsProgress(), "Read_as_progress", null) {Generic = true},
                new MenuItem(true) {Generic = true}, // --------------------------
            ...
            if (Config.IsDeveloper) {
                MainMenuList.Add(
                    new MenuItem(this, "Tests", ImageResources.Tests, null, null, null, new List<MenuItem> {
                        ...
                        new MenuItem(this, "Parse current file", ImageResources.TestTube, item => PlugDebug.ParseCurrentFile(), "ParseCurrentFile", "") {Generic = false},
