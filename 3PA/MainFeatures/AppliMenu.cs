    ...
    internal class AppliMenu {
        ...
        private AppliMenu() {
            ...
            MainMenuList = new List<MenuItem> {
                ...
                new MenuItem(this, "Show auto-completion at caret", ImageResources.Autocompletion, item => AutoCompletion.OnShowCompleteSuggestionList(), "Show_Suggestion_List", "Ctrl+Space") {Generic = true},
                new MenuItem(true) {Generic = true}, // --------------------------
