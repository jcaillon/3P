...
// This file (MardownDeep.cs) is part of 3P.
// 
...
namespace MarkdownDeep
{
	...
	public class Markdown
	{
        ...
        /// <summary>
        /// Converts an md string into html
        /// </summary>
        /// <param name="mdString"></param>
        /// <returns></returns>
	    public string ConvertToHtml(string mdString) {
	        return @"<div class='markdown-body'>" + Transform(mdString) + @"</div>";
	    }
