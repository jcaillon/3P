...
namespace _3PA.Forms
{
    partial class frmGoToLine : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            IntPtr curScintilla = Npp.HandleScintilla;
        ...
        private void frmGoToLine_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                Win32.SendMessage(Npp.HandleScintilla, SciMsg.SCI_GRABFOCUS, 0, 0);
            }
        ...
        void FrmGoToLineVisibleChanged(object sender, EventArgs e)
        {
        	if (!Visible)
        	{
                Win32.SendMessage(Npp.HandleNpp, NppMsg.NPPM_SETMENUITEMCHECK,
                                  Plug.FuncItems.Items[Plug.idFrmGotToLine]._cmdID, 0);
        	}
        }
    }
}
